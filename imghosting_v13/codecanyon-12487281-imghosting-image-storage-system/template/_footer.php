			   ...
			   $lang_f = scandir($home.'lang/');
                ...
                <?php }?>  
                 ...
                 <?php }?> 
                  ...
                  <div class="col-md-3"><p class="pull-right copy">© <?php if(date("Y",time())=='2018'){?>2018<?php }else{ echo '2015-'.date("Y",time());}?> <?php echo $SET['site_name']?> <?php if(isset($SET['show_version']) && $SET['show_version'] =1){?><a href="?change-log" target="_blank"><?php echo $SET['version']?></a><?php }?>.  Programming by <a href="http://linkerpt.com" target="_blank">Linkerpt</a></p></div>
